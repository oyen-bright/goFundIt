...
type Activity struct {
	...
	Contributors    []contributor.Contributor `gorm:"many2many:activity_contributors" binding:"-" json:"contributors"`
...
func (a *Activity) UpdateCreatedBy(user auth.User) {
