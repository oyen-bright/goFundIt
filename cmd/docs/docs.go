...
const docTemplate = `{
    ...
    "tags": [
        {
            "description": "Authentication operations including login, OTP verification, and FCM token management",
            "name": "auth"
        },
        {
            "description": "Campaign management operations including creation, updates, and retrieval",
            "name": "campaign"
        },
        {
            "description": "Activity tracking and management within campaigns",
            "name": "activity"
        },
        {
            "description": "Payment processing operations including initialization and verification",
            "name": "payment"
        },
        {
            "description": "Payout management for campaign funds",
            "name": "payout"
        },
        {
            "description": "AI-powered suggestions and recommendations for campaign activities",
            "name": "suggestion"
        },
        {
            "description": "Manage activity comments and replies.Features:- Create/Update/Delete comments- Thread management- Reply system- Comment retrieval",
            "name": "comment"
        }
    ]
}`
